...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  if ($stok == 'Seluruh') {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.jenis, a.stok, a.satuan_barang, a.pemasok
    ...
    while ($data = mysqli_fetch_assoc($query)) {
      ...
      $html .= '		<tr>
                      ...
                      <td width="70">' . $data['satuan_barang'] . '</td>
                      <td width="100">' . $data['pemasok'] . '</td>
                    </tr>';
    }
    $html .= '		</tbody>
                </table>
